...

{
...

    {
        ...
        [Tooltip("Controls if incoming NetObject updates from a current non-owner/controller should be ignored. " +
            ...
            "in which case the first arriving updates originating Realtime.Player will be treated as the current Controller, regardless of this setting.")]
...
//        public void OnOwnershipRequest(PhotonView targetView, Photon.Realtime.Realtime.Player requestingRealtime.Player) { }

//        public void OnOwnershipTransferred(PhotonView targetView, Photon.Realtime.Realtime.Player previousOwner)
//        {
