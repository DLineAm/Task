...
namespace TravelAgency.ViewModels
{
    public class HotelViewModel : BindableBase
    {
        ...
        private List<Hotels> _allHotels;

        public List<Hotels> AllHotels
        {
            get => _allHotels;
            set => SetProperty(ref _allHotels, value);
        }
        ...
        private async void AddHotel()
        {
            ...
            App.ShowNotification("Добавление отеля", $"Отель №{id} ({result.Name}) добавлен.");
        }
        ...
        private async Task<Hotels> OpenHotelDetailsView(HandleType handleType)
        {
