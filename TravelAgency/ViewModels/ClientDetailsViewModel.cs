...
namespace TravelAgency.ViewModels
{
    ...
    {
        public ClientDetailsViewModel(Clients client, HandleType handleType)
        {
        ...
        private void BindProperties(Clients client)
        {
            Client = client;
            Name = client.Name;
        ...
        public Clients Client { get => _client; set => SetProperty(ref _client, value); }
